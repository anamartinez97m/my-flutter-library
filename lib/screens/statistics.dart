              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      height: 240,
                      child: languageCounts.isEmpty
                          ? const Center(child: Text('No data'))
                          : BarChart(
                              BarChartData(
                                alignment: BarChartAlignment.spaceAround,
                                maxY: languageCounts.values.reduce((a, b) => a > b ? a : b).toDouble() + 4,
                                barGroups: languageCounts.entries.toList().asMap().entries.map((entry) {
                                ...
                                barTouchData: BarTouchData(
                                  ...
                                  touchTooltipData: BarTouchTooltipData(
                                    ...
                                    tooltipBorder: const BorderSide(color: Colors.deepPurple, width: 1),
                                  ...
                                  bottomTitles: AxisTitles(
                                    sideTitles: SideTitles(
                                      ...
                                      getTitlesWidget: (value, meta) {
                                        ...
                                        if (index >= 0 && index < languageCounts.length) {
                                          final key = languageCounts.keys.toList()[index];
                                          return Padding(
