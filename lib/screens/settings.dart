...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return _buildV2Scaffold(context, isAdmin: isAdmin);
  }
      ...
      children: [
        ...
        _buildV2SettingsButton(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const ManageDropdownsScreen()),
            );
          },
        ),
        const SizedBox(height: 12),
