...
class NewQuarterlyWinnerSelectionScreen extends StatefulWidget {
  final int year;
  final int quarter;

  const NewQuarterlyWinnerSelectionScreen({
    super.key,
    required this.year,
  ...
  @override
  State<NewQuarterlyWinnerSelectionScreen> createState() =>
      _NewQuarterlyWinnerSelectionScreenState();
}

class _NewQuarterlyWinnerSelectionScreenState
    extends State<NewQuarterlyWinnerSelectionScreen> {
              ...
              ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      l10n.no_monthly_winners_quarter,
