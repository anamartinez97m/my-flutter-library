...
class ReadingEfficiency5Card extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          _InsightRow(
            icon: Icons.timer,
            color: _kSecondary,
            headline: averageDaysToFinish > 0
